...
class Player(tk.Frame):
	...
	#Building Area for Displaying Song names
	def track_widgets(self):
		...
		self.songtrack['text'] = 'MP3 Player Using Python'
		self.songtrack.config(width=30, height=1)
		self.songtrack.grid(row=1,column=0,padx=10)

    #Building Area for displaying Control Buttons
	...
	#Building Area for displaying songs
	...
	#Adding Button for Playing Songs
	...
	#Adding Button for Pausing Songs
	def pause_song(self):
		if not self.paused:
			self.paused = True
			mixer.music.pause()
	...
	#Bulding button to play Previous song
	def prev_song(self):
		if self.current > 0:
			self.current -= 1
		else:
	...
	#Building button to play Next song
	def next_song(self):
	...
	#Building Button to Control volume 
...
#Applying images for the buttons
...
#Creating object for playing songs
